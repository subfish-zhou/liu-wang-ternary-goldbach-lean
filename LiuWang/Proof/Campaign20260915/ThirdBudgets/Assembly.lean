...
/-- The four actual unpaid terms, not an assumed numerical budget. -/
def unpaidRemainder (N q : ℕ) [NeZero q] : ℝ :=
  middleEndpoint N q + middleIntegral N q + sourceM5 N q + sourceHighRealTail N q
...
theorem S_and_primeS_original_payments {N q a : ℕ} [NeZero q]
  ...
  have h6 := sigma6_M6_paid hN hq.le hq1 hhigh htotient hnu hlocal
...
theorem original_payments_same_witness {N : ℕ} {alpha : ℝ}
  ...
  exact S_and_primeS_original_payments hN hi hq0 hq1 heta
    (htotient q hq0 hq1) (hnu q hq0 hq1) (hlow q hq0 hq1) (hhigh q hq0 hq1)
