import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q428.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q428.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q428

theorem original_region (chi : DirichletCharacter ℂ 428)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 428 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 428) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q428
