import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q465.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q465.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q465

theorem original_region (chi : DirichletCharacter ℂ 465)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 465 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q465
