import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q264.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q264.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 264)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 264 ≤ x)
