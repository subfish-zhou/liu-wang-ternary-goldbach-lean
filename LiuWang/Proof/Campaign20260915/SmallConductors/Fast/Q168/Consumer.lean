import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q168.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q168.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 168)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 168 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 168) (by decide) (by decide) (n := 46) (by decide)
