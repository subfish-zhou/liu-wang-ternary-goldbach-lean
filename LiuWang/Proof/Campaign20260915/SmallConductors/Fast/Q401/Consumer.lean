import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q401.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q401.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q401

theorem original_region (chi : DirichletCharacter ℂ 401)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 401 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 401) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q401
