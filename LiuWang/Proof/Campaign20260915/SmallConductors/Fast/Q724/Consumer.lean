import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q724.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q724.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q724

theorem original_region (chi : DirichletCharacter ℂ 724)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 724 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q724
