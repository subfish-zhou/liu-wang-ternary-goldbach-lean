import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q952.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q952.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q952

theorem original_region (chi : DirichletCharacter ℂ 952)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 952 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 952) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q952
