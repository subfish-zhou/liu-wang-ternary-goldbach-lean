import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q124.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q124.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q124.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q124.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q124.Sign3
...
theorem original_region (chi : DirichletCharacter ℂ 124)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 124 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 124) (by decide) (by decide) (n := 40) (by decide)
