import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q515.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q515.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 515)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 515 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 515) (by decide) (by decide) (n := 60) (by decide)
