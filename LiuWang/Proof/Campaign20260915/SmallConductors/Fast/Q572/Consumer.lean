import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q572.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q572.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 572)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 572 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 572) (by decide) (by decide) (n := 60) (by decide)
