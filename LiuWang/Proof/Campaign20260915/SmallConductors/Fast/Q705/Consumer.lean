import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q705.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q705.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q705

theorem original_region (chi : DirichletCharacter ℂ 705)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 705 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q705
