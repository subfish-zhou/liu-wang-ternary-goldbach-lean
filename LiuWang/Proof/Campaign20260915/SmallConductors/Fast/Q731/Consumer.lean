import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q731.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q731.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 731)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 731 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 731) (by decide) (by decide) (n := 60) (by decide)
