import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q119.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q119.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q119.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q119.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q119.Sign3
...
theorem original_region (chi : DirichletCharacter ℂ 119)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 119 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 119) (by decide) (by decide) (n := 40) (by decide)
