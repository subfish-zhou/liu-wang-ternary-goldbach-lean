import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q780.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q780.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q780

theorem original_region (chi : DirichletCharacter ℂ 780)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 780 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 780) (by decide) (by decide) (n := 60) (by decide)
      ((VerifiedScan.weighted_iff _ _ _ _ _).mp certificate11)
      (by norm_num) (by norm_num)
      (VerifiedScan.log_scale_dyadic (j := 9) (by norm_num; linarith)
        (by norm_num)) hb
  · exact False.elim ((not_primitive_of_kernel_entries chi _
      (d := 60) (by decide) (by decide) ht
      (by rw [values12_eq]; decide +kernel) certificate12) hp)
  · exact False.elim ((not_primitive_of_kernel_entries chi _
      (d := 390) (by decide) (by decide) ht
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q780
