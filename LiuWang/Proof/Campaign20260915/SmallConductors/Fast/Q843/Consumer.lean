import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q843.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q843.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 843)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 843 ≤ x)
