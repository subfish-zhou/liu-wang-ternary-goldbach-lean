import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q620.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q620.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q620

theorem original_region (chi : DirichletCharacter ℂ 620)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 620 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q620
