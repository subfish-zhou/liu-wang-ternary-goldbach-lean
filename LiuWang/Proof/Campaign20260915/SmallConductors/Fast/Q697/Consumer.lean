import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q697.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q697.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q697

theorem original_region (chi : DirichletCharacter ℂ 697)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 697 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 697) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q697
