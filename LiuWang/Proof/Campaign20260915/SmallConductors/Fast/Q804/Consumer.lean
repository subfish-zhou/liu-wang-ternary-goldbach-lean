import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q804.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q804.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q804

theorem original_region (chi : DirichletCharacter ℂ 804)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 804 ≤ x)
  ...
  · exact False.elim ((not_primitive_of_kernel_entries chi _
      (d := 402) (by decide) (by decide) ht
      (by rw [values0_eq]; decide +kernel) certificate0) hp)
  · exact False.elim ((not_primitive_of_kernel_entries chi _
      (d := 268) (by decide) (by decide) ht
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 804) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q804
