import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q399.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q399.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q399

theorem original_region (chi : DirichletCharacter ℂ 399)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 399 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 399) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q399
