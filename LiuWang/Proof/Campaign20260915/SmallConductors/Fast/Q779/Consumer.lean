import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q779.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q779.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q779

theorem original_region (chi : DirichletCharacter ℂ 779)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 779 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q779
