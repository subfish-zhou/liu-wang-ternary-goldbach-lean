import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q915.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q915.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q915

theorem original_region (chi : DirichletCharacter ℂ 915)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 915 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q915
