import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q476.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q476.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q476

theorem original_region (chi : DirichletCharacter ℂ 476)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 476 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q476
