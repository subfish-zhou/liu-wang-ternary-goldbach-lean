import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q939.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q939.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q939

theorem original_region (chi : DirichletCharacter ℂ 939)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 939 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q939
