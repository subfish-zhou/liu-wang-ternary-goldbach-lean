import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q884.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q884.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q884

theorem original_region (chi : DirichletCharacter ℂ 884)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 884 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q884
