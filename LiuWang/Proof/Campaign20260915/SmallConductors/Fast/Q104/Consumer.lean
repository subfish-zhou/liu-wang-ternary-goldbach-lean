import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q104.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q104.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q104.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q104.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q104.Sign3
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q104.Sign4
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q104.Sign5
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q104.Sign6
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q104.Sign7
...
theorem original_region (chi : DirichletCharacter ℂ 104)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 104 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 104) (by decide) (by decide) (n := 40) (by decide)
