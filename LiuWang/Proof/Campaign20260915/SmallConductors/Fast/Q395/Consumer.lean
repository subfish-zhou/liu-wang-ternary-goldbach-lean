import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q395.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q395.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 395)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 395 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 395) (by decide) (by decide) (n := 53) (by decide)
