import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q964.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q964.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q964

theorem original_region (chi : DirichletCharacter ℂ 964)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 964 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q964
