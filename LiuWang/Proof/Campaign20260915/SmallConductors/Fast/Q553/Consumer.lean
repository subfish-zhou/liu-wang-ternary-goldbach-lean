import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q553.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q553.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q553

theorem original_region (chi : DirichletCharacter ℂ 553)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 553 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 553) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q553
