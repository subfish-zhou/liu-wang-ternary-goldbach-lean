import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q956.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q956.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q956

theorem original_region (chi : DirichletCharacter ℂ 956)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 956 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q956
