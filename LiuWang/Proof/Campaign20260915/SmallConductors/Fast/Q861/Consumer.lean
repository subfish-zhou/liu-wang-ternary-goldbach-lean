import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q861.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q861.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q861

theorem original_region (chi : DirichletCharacter ℂ 861)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 861 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q861
