import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q916.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q916.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 916)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 916 ≤ x)
