import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q716.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q716.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q716

theorem original_region (chi : DirichletCharacter ℂ 716)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 716 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q716
