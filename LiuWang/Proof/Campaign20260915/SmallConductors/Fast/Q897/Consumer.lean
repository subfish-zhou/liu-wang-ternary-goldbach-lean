import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q897.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q897.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q897

theorem original_region (chi : DirichletCharacter ℂ 897)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 897 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q897
