import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q444.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q444.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 444)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 444 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 444) (by decide) (by decide) (n := 53) (by decide)
