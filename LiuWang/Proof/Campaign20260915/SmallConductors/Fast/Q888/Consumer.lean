import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q888.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q888.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q888

theorem original_region (chi : DirichletCharacter ℂ 888)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 888 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q888
