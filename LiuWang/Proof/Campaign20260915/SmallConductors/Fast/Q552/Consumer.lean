import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q552.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q552.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q552

theorem original_region (chi : DirichletCharacter ℂ 552)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 552 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q552
