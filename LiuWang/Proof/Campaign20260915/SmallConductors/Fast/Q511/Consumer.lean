import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q511.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q511.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q511

theorem original_region (chi : DirichletCharacter ℂ 511)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 511 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 511) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q511
