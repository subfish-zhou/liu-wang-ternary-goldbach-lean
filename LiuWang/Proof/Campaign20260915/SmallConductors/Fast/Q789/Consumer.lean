import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q789.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q789.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q789

theorem original_region (chi : DirichletCharacter ℂ 789)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 789 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q789
