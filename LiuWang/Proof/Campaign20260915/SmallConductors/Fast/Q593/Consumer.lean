import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q593.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q593.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q593

theorem original_region (chi : DirichletCharacter ℂ 593)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 593 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 593) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q593
