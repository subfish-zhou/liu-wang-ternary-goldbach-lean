import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q872.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q872.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q872

theorem original_region (chi : DirichletCharacter ℂ 872)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 872 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 872) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q872
