import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q892.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q892.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q892

theorem original_region (chi : DirichletCharacter ℂ 892)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 892 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 892) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q892
