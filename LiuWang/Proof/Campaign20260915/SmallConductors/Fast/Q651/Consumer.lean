import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q651.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q651.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q651

theorem original_region (chi : DirichletCharacter ℂ 651)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 651 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q651
