import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q744.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q744.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q744

theorem original_region (chi : DirichletCharacter ℂ 744)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 744 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q744
