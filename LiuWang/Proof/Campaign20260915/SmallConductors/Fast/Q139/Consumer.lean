import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q139.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q139.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q139.Sign1
...
theorem original_region (chi : DirichletCharacter ℂ 139)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 139 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 139) (by decide) (by decide) (n := 46) (by decide)
