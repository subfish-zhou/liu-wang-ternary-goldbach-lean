import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q533.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q533.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q533

theorem original_region (chi : DirichletCharacter ℂ 533)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 533 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 533) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q533
