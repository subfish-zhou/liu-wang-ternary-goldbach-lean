import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q979.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q979.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q979.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q979.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q979.Sign3
...
theorem original_region (chi : DirichletCharacter ℂ 979)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 979 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 979) (by decide) (by decide) (n := 60) (by decide)
