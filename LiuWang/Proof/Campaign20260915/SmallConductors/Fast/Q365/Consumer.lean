import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q365.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q365.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q365

theorem original_region (chi : DirichletCharacter ℂ 365)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 365 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 365) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q365
