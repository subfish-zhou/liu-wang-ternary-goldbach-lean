import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q604.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q604.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 604)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 604 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 604) (by decide) (by decide) (n := 60) (by decide)
