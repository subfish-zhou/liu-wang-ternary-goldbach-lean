import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q105.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q105.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q105.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q105.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q105.Sign3
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q105.Sign4
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q105.Sign5
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q105.Sign6
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q105.Sign7
...
theorem original_region (chi : DirichletCharacter ℂ 105)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 105 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 105) (by decide) (by decide) (n := 40) (by decide)
