import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q772.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q772.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q772

theorem original_region (chi : DirichletCharacter ℂ 772)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 772 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 772) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q772
