import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q109.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q109.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q109.Sign1
...
theorem original_region (chi : DirichletCharacter ℂ 109)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 109 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 109) (by decide) (by decide) (n := 40) (by decide)
