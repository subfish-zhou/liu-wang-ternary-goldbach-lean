import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q627.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q627.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 627)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 627 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 627) (by decide) (by decide) (n := 60) (by decide)
