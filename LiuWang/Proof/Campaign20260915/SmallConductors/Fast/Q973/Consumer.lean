import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q973.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q973.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q973

theorem original_region (chi : DirichletCharacter ℂ 973)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 973 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q973
