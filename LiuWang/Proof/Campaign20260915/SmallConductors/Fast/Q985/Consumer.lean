import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q985.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q985.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q985.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q985.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q985.Sign3
...
theorem original_region (chi : DirichletCharacter ℂ 985)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 985) (by decide) (by decide) (n := 60) (by decide)
