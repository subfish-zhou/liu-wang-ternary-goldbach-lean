import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q244.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q244.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 244)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 244 ≤ x)
