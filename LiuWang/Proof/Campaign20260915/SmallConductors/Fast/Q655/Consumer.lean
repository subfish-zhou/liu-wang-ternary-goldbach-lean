import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q655.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q655.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q655

theorem original_region (chi : DirichletCharacter ℂ 655)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 655 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 655) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q655
