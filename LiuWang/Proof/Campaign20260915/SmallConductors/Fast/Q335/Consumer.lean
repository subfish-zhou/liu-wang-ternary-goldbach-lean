import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q335.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q335.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q335

theorem original_region (chi : DirichletCharacter ℂ 335)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 335 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 335) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q335
