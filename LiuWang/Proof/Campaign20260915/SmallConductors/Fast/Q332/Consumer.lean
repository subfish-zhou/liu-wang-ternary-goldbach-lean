import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q332.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q332.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q332

theorem original_region (chi : DirichletCharacter ℂ 332)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 332 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 332) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q332
