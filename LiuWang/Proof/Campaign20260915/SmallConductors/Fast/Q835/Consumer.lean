import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q835.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q835.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q835

theorem original_region (chi : DirichletCharacter ℂ 835)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 835 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q835
