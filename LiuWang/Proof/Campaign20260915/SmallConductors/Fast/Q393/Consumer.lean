import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q393.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q393.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q393

theorem original_region (chi : DirichletCharacter ℂ 393)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 393 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 393) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q393
