import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q123.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q123.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q123.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q123.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q123.Sign3
...
theorem original_region (chi : DirichletCharacter ℂ 123)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 123 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 123) (by decide) (by decide) (n := 40) (by decide)
