import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q236.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q236.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 236)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 236 ≤ x)
