import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q111.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q111.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q111.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q111.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q111.Sign3
...
theorem original_region (chi : DirichletCharacter ℂ 111)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 111 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 111) (by decide) (by decide) (n := 40) (by decide)
