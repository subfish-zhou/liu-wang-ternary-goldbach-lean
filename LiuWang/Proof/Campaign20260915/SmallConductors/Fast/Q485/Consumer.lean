import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q485.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q485.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q485

theorem original_region (chi : DirichletCharacter ℂ 485)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 485 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q485
