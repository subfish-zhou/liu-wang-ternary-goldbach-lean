import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q696.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q696.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q696

theorem original_region (chi : DirichletCharacter ℂ 696)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 696 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q696
