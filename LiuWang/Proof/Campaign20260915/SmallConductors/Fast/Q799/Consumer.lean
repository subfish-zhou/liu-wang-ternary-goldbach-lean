import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q799.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q799.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q799

theorem original_region (chi : DirichletCharacter ℂ 799)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 799 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 799) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q799
