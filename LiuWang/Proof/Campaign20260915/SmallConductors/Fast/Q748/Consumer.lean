import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q748.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q748.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 748)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 748 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 748) (by decide) (by decide) (n := 60) (by decide)
