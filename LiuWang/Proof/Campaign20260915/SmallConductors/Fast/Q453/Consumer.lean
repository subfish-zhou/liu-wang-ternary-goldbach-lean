import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q453.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q453.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 453)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 453 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 453) (by decide) (by decide) (n := 53) (by decide)
