import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q172.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q172.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 172)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 172 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 172) (by decide) (by decide) (n := 46) (by decide)
