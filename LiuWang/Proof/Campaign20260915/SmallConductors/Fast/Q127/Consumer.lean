import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q127.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q127.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q127.Sign1
...
theorem original_region (chi : DirichletCharacter ℂ 127)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 127 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 127) (by decide) (by decide) (n := 40) (by decide)
