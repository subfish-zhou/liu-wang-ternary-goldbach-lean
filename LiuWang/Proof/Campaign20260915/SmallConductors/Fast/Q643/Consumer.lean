import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q643.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q643.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 643)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 643 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 643) (by decide) (by decide) (n := 60) (by decide)
