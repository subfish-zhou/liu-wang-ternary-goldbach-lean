import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q140.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q140.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q140.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q140.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q140.Sign3
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q140.Sign4
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q140.Sign5
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q140.Sign6
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q140.Sign7
...
theorem original_region (chi : DirichletCharacter ℂ 140)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 140 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 140) (by decide) (by decide) (n := 46) (by decide)
