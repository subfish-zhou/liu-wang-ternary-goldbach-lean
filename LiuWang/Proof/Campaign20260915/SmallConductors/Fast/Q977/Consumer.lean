import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q977.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q977.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q977.Sign1
...
theorem original_region (chi : DirichletCharacter ℂ 977)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 977 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 977) (by decide) (by decide) (n := 60) (by decide)
