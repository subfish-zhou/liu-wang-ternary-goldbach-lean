import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q740.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q740.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q740

theorem original_region (chi : DirichletCharacter ℂ 740)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 740 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q740
