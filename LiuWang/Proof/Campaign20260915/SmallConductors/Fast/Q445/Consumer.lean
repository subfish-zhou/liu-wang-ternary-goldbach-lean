import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q445.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q445.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 445)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 445 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 445) (by decide) (by decide) (n := 53) (by decide)
