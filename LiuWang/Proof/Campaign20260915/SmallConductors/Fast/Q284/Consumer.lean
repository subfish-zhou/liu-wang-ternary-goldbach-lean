import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q284.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q284.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 284)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 284 ≤ x)
