import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q732.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q732.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q732

theorem original_region (chi : DirichletCharacter ℂ 732)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 732 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q732
