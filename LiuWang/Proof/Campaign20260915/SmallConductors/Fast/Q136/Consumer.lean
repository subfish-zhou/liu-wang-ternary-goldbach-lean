import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q136.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q136.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q136.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q136.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q136.Sign3
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q136.Sign4
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q136.Sign5
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q136.Sign6
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q136.Sign7
...
theorem original_region (chi : DirichletCharacter ℂ 136)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 136 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 136) (by decide) (by decide) (n := 46) (by decide)
      ((VerifiedScan.weighted_iff _ _ _ _ _).mp certificate1)
      (by norm_num) (by norm_num)
      (VerifiedScan.log_scale_dyadic (j := 7) (by norm_num; linarith)
        (by norm_num)) hb
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 136) (by decide) (by decide) (n := 46) (by decide)
