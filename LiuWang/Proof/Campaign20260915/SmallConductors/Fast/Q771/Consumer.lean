import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q771.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q771.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q771

theorem original_region (chi : DirichletCharacter ℂ 771)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 771 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q771
