import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q687.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q687.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 687)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 687 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 687) (by decide) (by decide) (n := 60) (by decide)
