import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q984.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q984.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q984

theorem original_region (chi : DirichletCharacter ℂ 984)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 984 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q984
