import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q235.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q235.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 235)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 235 ≤ x)
  ...
  · exact False.elim ((not_primitive_of_kernel_entries chi _
      (d := 47) (by decide) (by decide) ht
      (by rw [values0_eq]; decide +kernel) certificate0) hp)
  · exact False.elim ((not_primitive_of_kernel_entries chi _
      (d := 5) (by decide) (by decide) ht
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 235) (by decide) (by decide) (n := 46) (by decide)
