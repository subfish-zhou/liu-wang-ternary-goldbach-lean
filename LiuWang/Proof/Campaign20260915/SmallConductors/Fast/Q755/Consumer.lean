import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q755.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q755.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q755

theorem original_region (chi : DirichletCharacter ℂ 755)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 755 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q755
