import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q132.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q132.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q132.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q132.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q132.Sign3
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q132.Sign4
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q132.Sign5
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q132.Sign6
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q132.Sign7
...
theorem original_region (chi : DirichletCharacter ℂ 132)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 132 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 132) (by decide) (by decide) (n := 46) (by decide)
