import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q728.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q728.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q728

theorem original_region (chi : DirichletCharacter ℂ 728)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 728 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 728) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q728
