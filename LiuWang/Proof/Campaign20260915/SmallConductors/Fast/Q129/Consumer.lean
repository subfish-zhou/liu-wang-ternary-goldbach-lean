import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q129.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q129.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q129.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q129.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q129.Sign3
...
theorem original_region (chi : DirichletCharacter ℂ 129)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 129 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 129) (by decide) (by decide) (n := 46) (by decide)
