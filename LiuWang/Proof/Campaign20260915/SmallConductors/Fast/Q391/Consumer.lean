import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q391.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q391.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q391

theorem original_region (chi : DirichletCharacter ℂ 391)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 391 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 391) (by decide) (by decide) (n := 53) (by decide)
  ...
  · exact False.elim ((not_primitive_of_kernel_entries chi _
      (d := 17) (by decide) (by decide) ht
      (by rw [values3_eq]; decide +kernel) certificate3) hp)

#print axioms original_region

end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q391
