import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q551.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q551.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q551

theorem original_region (chi : DirichletCharacter ℂ 551)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 551 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 551) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q551
