import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q492.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q492.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q492

theorem original_region (chi : DirichletCharacter ℂ 492)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 492 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 492) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q492
