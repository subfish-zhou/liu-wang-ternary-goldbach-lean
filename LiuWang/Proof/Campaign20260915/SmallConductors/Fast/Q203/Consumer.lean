import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q203.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q203.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 203)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 203 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 203) (by decide) (by decide) (n := 46) (by decide)
