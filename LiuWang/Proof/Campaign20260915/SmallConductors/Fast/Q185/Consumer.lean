import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q185.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q185.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 185)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 185 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 185) (by decide) (by decide) (n := 46) (by decide)
