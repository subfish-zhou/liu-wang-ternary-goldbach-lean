import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q764.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q764.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q764

theorem original_region (chi : DirichletCharacter ℂ 764)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 764 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q764
