import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q489.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q489.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 489)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 489 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 489) (by decide) (by decide) (n := 53) (by decide)
