import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q904.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q904.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q904

theorem original_region (chi : DirichletCharacter ℂ 904)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 904 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q904
