import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q597.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q597.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q597

theorem original_region (chi : DirichletCharacter ℂ 597)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 597 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q597
