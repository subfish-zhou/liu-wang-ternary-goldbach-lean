import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q923.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q923.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q923

theorem original_region (chi : DirichletCharacter ℂ 923)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 923 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 923) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q923
