import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q408.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q408.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q408

theorem original_region (chi : DirichletCharacter ℂ 408)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 408 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q408
