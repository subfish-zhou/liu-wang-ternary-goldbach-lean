import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q564.Data
...
theorem cover : SquareWordCover 564 generators words :=
  cover_of_entries generators words (by decide +kernel) (by decide +kernel)

theorem units : ∀ i, IsUnit (generators i : ZMod 564) :=
