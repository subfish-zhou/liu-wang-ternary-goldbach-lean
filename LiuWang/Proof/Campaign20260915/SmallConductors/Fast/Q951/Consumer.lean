import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q951.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q951.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q951

theorem original_region (chi : DirichletCharacter ℂ 951)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 951 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 951) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q951
