import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q820.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q820.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q820

theorem original_region (chi : DirichletCharacter ℂ 820)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 820 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q820
