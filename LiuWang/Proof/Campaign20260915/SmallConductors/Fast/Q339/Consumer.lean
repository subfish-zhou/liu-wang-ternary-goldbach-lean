import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q339.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q339.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q339

theorem original_region (chi : DirichletCharacter ℂ 339)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 339 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q339
