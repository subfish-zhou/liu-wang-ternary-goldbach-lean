import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q781.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q781.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q781

theorem original_region (chi : DirichletCharacter ℂ 781)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 781 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q781
