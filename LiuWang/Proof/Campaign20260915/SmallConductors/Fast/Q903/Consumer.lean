import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q903.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q903.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q903

theorem original_region (chi : DirichletCharacter ℂ 903)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 903 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q903
