import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q569.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q569.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 569)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 569 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 569) (by decide) (by decide) (n := 60) (by decide)
