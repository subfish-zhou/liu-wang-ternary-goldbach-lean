import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q247.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q247.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q247

theorem original_region (chi : DirichletCharacter ℂ 247)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 247 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q247
