import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q137.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q137.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q137.Sign1
...
theorem original_region (chi : DirichletCharacter ℂ 137)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 137 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 137) (by decide) (by decide) (n := 46) (by decide)
