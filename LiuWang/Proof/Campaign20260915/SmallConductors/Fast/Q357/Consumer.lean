import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q357.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q357.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q357

theorem original_region (chi : DirichletCharacter ℂ 357)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 357 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 357) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q357
