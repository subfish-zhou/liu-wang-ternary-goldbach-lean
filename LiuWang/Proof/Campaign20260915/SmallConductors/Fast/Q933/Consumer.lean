import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q933.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q933.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q933

theorem original_region (chi : DirichletCharacter ℂ 933)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 933 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q933
