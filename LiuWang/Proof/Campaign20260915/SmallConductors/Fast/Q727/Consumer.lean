import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q727.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q727.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q727

theorem original_region (chi : DirichletCharacter ℂ 727)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 727 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 727) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q727
