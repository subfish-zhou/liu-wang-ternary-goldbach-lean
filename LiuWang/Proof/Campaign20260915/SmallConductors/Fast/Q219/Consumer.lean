import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q219.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q219.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 219)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 219 ≤ x)
