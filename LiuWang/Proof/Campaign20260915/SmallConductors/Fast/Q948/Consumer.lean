import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q948.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q948.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q948

theorem original_region (chi : DirichletCharacter ℂ 948)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 948 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q948
