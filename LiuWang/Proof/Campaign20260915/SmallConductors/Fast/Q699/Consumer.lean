import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q699.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q699.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 699)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 699 ≤ x)
