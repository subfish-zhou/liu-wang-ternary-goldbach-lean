import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q183.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q183.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 183)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 183 ≤ x)
