import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q107.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q107.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q107.Sign1
...
theorem original_region (chi : DirichletCharacter ℂ 107)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 107 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 107) (by decide) (by decide) (n := 40) (by decide)
