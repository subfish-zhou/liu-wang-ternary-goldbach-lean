import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q248.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q248.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 248)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 248 ≤ x)
