import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q161.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q161.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 161)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 161 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 161) (by decide) (by decide) (n := 46) (by decide)
