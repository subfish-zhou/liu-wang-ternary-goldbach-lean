import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q664.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q664.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q664

theorem original_region (chi : DirichletCharacter ℂ 664)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 664 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q664
