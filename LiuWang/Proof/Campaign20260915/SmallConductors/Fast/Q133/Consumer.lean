import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q133.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q133.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q133.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q133.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q133.Sign3
...
theorem original_region (chi : DirichletCharacter ℂ 133)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 133 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 133) (by decide) (by decide) (n := 46) (by decide)
