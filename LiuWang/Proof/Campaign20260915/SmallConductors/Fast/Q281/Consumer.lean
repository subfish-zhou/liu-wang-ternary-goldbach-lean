import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q281.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q281.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 281)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 281 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 281) (by decide) (by decide) (n := 53) (by decide)
