import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q580.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q580.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 580)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 580 ≤ x)
