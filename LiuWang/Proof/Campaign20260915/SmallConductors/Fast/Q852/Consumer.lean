import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q852.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q852.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q852

theorem original_region (chi : DirichletCharacter ℂ 852)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 852 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 852) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q852
