import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q669.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q669.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q669

theorem original_region (chi : DirichletCharacter ℂ 669)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 669 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q669
