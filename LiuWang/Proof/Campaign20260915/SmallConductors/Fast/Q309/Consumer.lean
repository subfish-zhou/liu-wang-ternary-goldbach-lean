import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q309.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q309.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q309

theorem original_region (chi : DirichletCharacter ℂ 309)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 309 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q309
