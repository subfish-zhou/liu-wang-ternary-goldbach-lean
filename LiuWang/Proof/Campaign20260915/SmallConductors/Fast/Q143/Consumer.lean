import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q143.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q143.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q143.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q143.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q143.Sign3
...
theorem original_region (chi : DirichletCharacter ℂ 143)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 143 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 143) (by decide) (by decide) (n := 46) (by decide)
