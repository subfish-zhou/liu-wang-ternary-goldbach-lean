import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q836.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q836.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q836

theorem original_region (chi : DirichletCharacter ℂ 836)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 836 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q836
