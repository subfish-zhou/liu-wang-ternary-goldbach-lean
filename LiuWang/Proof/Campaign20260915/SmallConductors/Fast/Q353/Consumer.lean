import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q353.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q353.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 353)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 353 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 353) (by decide) (by decide) (n := 53) (by decide)
