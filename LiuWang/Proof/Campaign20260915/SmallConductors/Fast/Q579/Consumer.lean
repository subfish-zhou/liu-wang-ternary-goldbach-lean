import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q579.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q579.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q579

theorem original_region (chi : DirichletCharacter ℂ 579)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 579 ≤ x)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q579
