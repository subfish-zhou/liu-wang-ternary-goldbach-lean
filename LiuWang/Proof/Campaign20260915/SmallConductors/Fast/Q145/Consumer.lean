import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q145.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q145.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q145.Sign1
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q145.Sign2
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q145.Sign3
...
theorem original_region (chi : DirichletCharacter ℂ 145)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 145 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 145) (by decide) (by decide) (n := 46) (by decide)
