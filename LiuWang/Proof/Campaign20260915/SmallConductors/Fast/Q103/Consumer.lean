import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q103.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q103.Sign0
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q103.Sign1
...
theorem original_region (chi : DirichletCharacter ℂ 103)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 103 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 103) (by decide) (by decide) (n := 40) (by decide)
