import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q173.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q173.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 173)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 173 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 173) (by decide) (by decide) (n := 46) (by decide)
