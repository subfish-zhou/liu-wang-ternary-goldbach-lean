import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q671.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q671.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q671

theorem original_region (chi : DirichletCharacter ℂ 671)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 671 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 671) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q671
