import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q907.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q907.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q907

theorem original_region (chi : DirichletCharacter ℂ 907)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 907 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 907) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q907
