import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q517.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q517.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q517

theorem original_region (chi : DirichletCharacter ℂ 517)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 517 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 517) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q517
