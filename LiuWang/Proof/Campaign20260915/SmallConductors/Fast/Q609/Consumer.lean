import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q609.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q609.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q609

theorem original_region (chi : DirichletCharacter ℂ 609)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 609 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 609) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q609
