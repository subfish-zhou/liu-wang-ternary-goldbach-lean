import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q796.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q796.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q796

theorem original_region (chi : DirichletCharacter ℂ 796)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 796 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 796) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q796
