import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q299.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q299.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q299

theorem original_region (chi : DirichletCharacter ℂ 299)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 299 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 299) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q299
