import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q381.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q381.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q381

theorem original_region (chi : DirichletCharacter ℂ 381)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 381 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 381) (by decide) (by decide) (n := 53) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q381
