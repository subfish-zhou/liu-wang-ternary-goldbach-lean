import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q631.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q631.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 631)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 631 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 631) (by decide) (by decide) (n := 60) (by decide)
