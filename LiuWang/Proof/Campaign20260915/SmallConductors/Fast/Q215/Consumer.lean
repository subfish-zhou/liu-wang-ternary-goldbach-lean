import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q215.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q215.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 215)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 215 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 215) (by decide) (by decide) (n := 46) (by decide)
