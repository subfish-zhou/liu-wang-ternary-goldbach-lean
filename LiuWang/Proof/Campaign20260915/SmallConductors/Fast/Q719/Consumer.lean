import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q719.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q719.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 719)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 719 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 719) (by decide) (by decide) (n := 60) (by decide)
