import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q659.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q659.Certificates
...
namespace LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q659

theorem original_region (chi : DirichletCharacter ℂ 659)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 659 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 659) (by decide) (by decide) (n := 60) (by decide)
...
end LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q659
