import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q267.Cover
import LiuWang.Proof.Campaign20260915.SmallConductors.Fast.Q267.Certificates
...
theorem original_region (chi : DirichletCharacter ℂ 267)
    (hp : chi.IsPrimitive)
    (hc : chi ≠ 1) (hsq : chi ^ 2 = 1) {x beta : ℝ} (hx : 267 ≤ x)
  ...
  · exact rationalWeighted_original_region chi hc _ ht
      (m := 267) (by decide) (by decide) (n := 53) (by decide)
